...
Frame* getScaledFrame(const std::string& name,float scale);
Frame* getChunkFrame(const std::string& name,unsigned int chunk_width,unsigned int  chunk_height,float source_x,float source_y);
